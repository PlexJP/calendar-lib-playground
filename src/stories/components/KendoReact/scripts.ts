export const SCHEDULE_BASE_DATA_LIST = [
  {
    TaskID: 4,
    OwnerID: 2,
...
export const sampleData = SCHEDULE_BASE_DATA_LIST.map(dataItem => ({
  id: dataItem.TaskID,
...
export const sampleDataWithResources = SCHEDULE_BASE_DATA_LIST.map(
  dataItem => ({
    id: dataItem.TaskID,
    start: parseAdjust(dataItem.Start),
    // startTimezone: dataItem.startTimezone,
...
export const sampleDataWithCustomSchema = SCHEDULE_BASE_DATA_LIST.map(
  dataItem => ({
    ...dataItem,
    Start: parseAdjust(dataItem.Start),
    End: parseAdjust(dataItem.End),
